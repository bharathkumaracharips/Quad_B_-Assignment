...
import { idlFactory } from './icp_token_wallet.did.js';
export { idlFactory } from './icp_token_wallet.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_TOKEN_WALLET;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_token_wallet.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_token_wallet canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_token_wallet.did.js")._SERVICE>}
 */
export const icp_token_wallet = createActor(canisterId);
